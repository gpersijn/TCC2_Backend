...
//
//import net.javaguides.springboot.Mock.FuncionarioDTOMock;
...
//        // Arrange
//        int funcionarioId = 1;
//        Funcionario funcionario = FuncionarioDTOMock.valorPadrao();
...
//        funcionarios.add(FuncionarioDTOMock.valorPadrao());
//        funcionarios.add(FuncionarioDTOMock.valorPadrao());
...
//        // Arrange
//        FuncionarioDTO funcionarioDTO = FuncionarioDTOMock.dtoPadrao();
//        Funcionario novoFuncionario = FuncionarioDTOMock.valorPadrao();
...
//        // Arrange
//        PerfilDTO perfilDTO = new PerfilDTO("funcionario@gmail.com", PerfilEnum.ADMIN);
//        Funcionario funcionario = FuncionarioDTOMock.valorPadrao();
...
//        // Arrange
//        List<Funcionario> tecnicosNaoAprovados = new ArrayList<>();
//        tecnicosNaoAprovados.add(FuncionarioDTOMock.valorPadrao());
